// Generated on 2017-04-28 using generator-angular-fullstack 4.2.0
'use strict';

/******************************************************************************************
 * CHANGE REQUEST    |     DESCRIPTION                       | DATE          |  OWNER
 *                   |                                       |               |
 ******************************************************************************************
 * CR-20170430-01    | Define defult task to run with PM2    | 30-MAR-2017   | Sri                 
 *                   | for production                        |               |
 ******************************************************************************************
 *
 *
...
/********************
 * CR-20170430-01 START
 ********************/
gulp.task('default',['env:prod', 'start:server:prod'],function(){
...
gulp.task('client:install', run('npm install --prefix client'))
 ...
 ********************/
 ...
 //client build...
gulp.task('client:build', run('npm run build:prod --prefix client'))
